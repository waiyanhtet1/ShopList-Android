...
@Composable
fun ProfileDetailPage(userProfile: UserProfile = UserProfileList[0]) {
    Scaffold(
        ...
        Surface(
            ...
            Column(
                ...
                ProfileContent(userProfile.name, userProfile.status , nameSize =  MaterialTheme.typography.headlineMedium)
            }
        }
    }
}
